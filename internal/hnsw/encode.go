...
// SavedGraph/LoadSavedGraph/Save foram removidos deste fork vendorizado: dependiam
// de renameio.TempFile, que não tem implementação para Windows na v1 da lib (ver
// internal/hnsw/NOTICE.md). uRag-go não persiste o índice ANN (decisão de escopo,
// ver SPEC.md) — Export/Import continuam disponíveis para quem quiser persistir
